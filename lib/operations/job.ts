...
export class Job {
   ...
   */
  async getAllLifetimeStatisticsWithHttpOperationResponse(options?: { jobGetAllLifetimeStatisticsOptions? : Models.JobGetAllLifetimeStatisticsOptions, customHeaders? : { [headerName: string]: string; } }): Promise<msRest.HttpOperationResponse> {
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  async deleteMethodWithHttpOperationResponse(jobId: string, options?: { jobDeleteMethodOptions? : Models.JobDeleteMethodOptions, customHeaders? : { [headerName: string]: string; } }): Promise<msRest.HttpOperationResponse> {
    let client = this.client;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  async getWithHttpOperationResponse(jobId: string, options?: { jobGetOptions? : Models.JobGetOptions, customHeaders? : { [headerName: string]: string; } }): Promise<msRest.HttpOperationResponse> {
    let client = this.client;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  async patchWithHttpOperationResponse(jobId: string, jobPatchParameter: Models.JobPatchParameter, options?: { jobPatchOptions? : Models.JobPatchOptions, customHeaders? : { [headerName: string]: string; } }): Promise<msRest.HttpOperationResponse> {
    let client = this.client;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  async updateWithHttpOperationResponse(jobId: string, jobUpdateParameter: Models.JobUpdateParameter, options?: { jobUpdateOptions? : Models.JobUpdateOptions, customHeaders? : { [headerName: string]: string; } }): Promise<msRest.HttpOperationResponse> {
    let client = this.client;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  async disableWithHttpOperationResponse(jobId: string, disableTasks: string, options?: { jobDisableOptions? : Models.JobDisableOptions, customHeaders? : { [headerName: string]: string; } }): Promise<msRest.HttpOperationResponse> {
    let client = this.client;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  async enableWithHttpOperationResponse(jobId: string, options?: { jobEnableOptions? : Models.JobEnableOptions, customHeaders? : { [headerName: string]: string; } }): Promise<msRest.HttpOperationResponse> {
    let client = this.client;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  async terminateWithHttpOperationResponse(jobId: string, options?: { terminateReason? : string, jobTerminateOptions? : Models.JobTerminateOptions, customHeaders? : { [headerName: string]: string; } }): Promise<msRest.HttpOperationResponse> {
    let client = this.client;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  async addWithHttpOperationResponse(job: Models.JobAddParameter, options?: { jobAddOptions? : Models.JobAddOptions, customHeaders? : { [headerName: string]: string; } }): Promise<msRest.HttpOperationResponse> {
    let client = this.client;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  async listWithHttpOperationResponse(options?: { jobListOptions? : Models.JobListOptions, customHeaders? : { [headerName: string]: string; } }): Promise<msRest.HttpOperationResponse> {
    let client = this.client;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  async listFromJobScheduleWithHttpOperationResponse(jobScheduleId: string, options?: { jobListFromJobScheduleOptions? : Models.JobListFromJobScheduleOptions, customHeaders? : { [headerName: string]: string; } }): Promise<msRest.HttpOperationResponse> {
    let client = this.client;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  async listPreparationAndReleaseTaskStatusWithHttpOperationResponse(jobId: string, options?: { jobListPreparationAndReleaseTaskStatusOptions? : Models.JobListPreparationAndReleaseTaskStatusOptions, customHeaders? : { [headerName: string]: string; } }): Promise<msRest.HttpOperationResponse> {
    let client = this.client;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  async getTaskCountsWithHttpOperationResponse(jobId: string, options?: { jobGetTaskCountsOptions? : Models.JobGetTaskCountsOptions, customHeaders? : { [headerName: string]: string; } }): Promise<msRest.HttpOperationResponse> {
    let client = this.client;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  async listNextWithHttpOperationResponse(nextPageLink: string, options?: { jobListNextOptions? : Models.JobListNextOptions, customHeaders? : { [headerName: string]: string; } }): Promise<msRest.HttpOperationResponse> {
    let client = this.client;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  async listFromJobScheduleNextWithHttpOperationResponse(nextPageLink: string, options?: { jobListFromJobScheduleNextOptions? : Models.JobListFromJobScheduleNextOptions, customHeaders? : { [headerName: string]: string; } }): Promise<msRest.HttpOperationResponse> {
    let client = this.client;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  async listPreparationAndReleaseTaskStatusNextWithHttpOperationResponse(nextPageLink: string, options?: { jobListPreparationAndReleaseTaskStatusNextOptions? : Models.JobListPreparationAndReleaseTaskStatusNextOptions, customHeaders? : { [headerName: string]: string; } }): Promise<msRest.HttpOperationResponse> {
    let client = this.client;
  ...
  getAllLifetimeStatistics(options: { jobGetAllLifetimeStatisticsOptions? : Models.JobGetAllLifetimeStatisticsOptions, customHeaders? : { [headerName: string]: string; } }, callback: msRest.ServiceCallback<Models.JobStatistics>): void;
  getAllLifetimeStatistics(options?: { jobGetAllLifetimeStatisticsOptions? : Models.JobGetAllLifetimeStatisticsOptions, customHeaders? : { [headerName: string]: string; } }, callback?: msRest.ServiceCallback<Models.JobStatistics>): any {
  ...
  deleteMethod(jobId: string, options: { jobDeleteMethodOptions? : Models.JobDeleteMethodOptions, customHeaders? : { [headerName: string]: string; } }, callback: msRest.ServiceCallback<void>): void;
  deleteMethod(jobId: string, options?: { jobDeleteMethodOptions? : Models.JobDeleteMethodOptions, customHeaders? : { [headerName: string]: string; } }, callback?: msRest.ServiceCallback<void>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
  ...
  get(jobId: string, options: { jobGetOptions? : Models.JobGetOptions, customHeaders? : { [headerName: string]: string; } }, callback: msRest.ServiceCallback<Models.CloudJob>): void;
  get(jobId: string, options?: { jobGetOptions? : Models.JobGetOptions, customHeaders? : { [headerName: string]: string; } }, callback?: msRest.ServiceCallback<Models.CloudJob>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
  ...
  patch(jobId: string, jobPatchParameter: Models.JobPatchParameter, options: { jobPatchOptions? : Models.JobPatchOptions, customHeaders? : { [headerName: string]: string; } }, callback: msRest.ServiceCallback<void>): void;
  patch(jobId: string, jobPatchParameter: Models.JobPatchParameter, options?: { jobPatchOptions? : Models.JobPatchOptions, customHeaders? : { [headerName: string]: string; } }, callback?: msRest.ServiceCallback<void>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
  ...
  update(jobId: string, jobUpdateParameter: Models.JobUpdateParameter, options: { jobUpdateOptions? : Models.JobUpdateOptions, customHeaders? : { [headerName: string]: string; } }, callback: msRest.ServiceCallback<void>): void;
  update(jobId: string, jobUpdateParameter: Models.JobUpdateParameter, options?: { jobUpdateOptions? : Models.JobUpdateOptions, customHeaders? : { [headerName: string]: string; } }, callback?: msRest.ServiceCallback<void>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
  ...
  disable(jobId: string, disableTasks: string, options: { jobDisableOptions? : Models.JobDisableOptions, customHeaders? : { [headerName: string]: string; } }, callback: msRest.ServiceCallback<void>): void;
  disable(jobId: string, disableTasks: string, options?: { jobDisableOptions? : Models.JobDisableOptions, customHeaders? : { [headerName: string]: string; } }, callback?: msRest.ServiceCallback<void>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
  ...
  enable(jobId: string, options: { jobEnableOptions? : Models.JobEnableOptions, customHeaders? : { [headerName: string]: string; } }, callback: msRest.ServiceCallback<void>): void;
  enable(jobId: string, options?: { jobEnableOptions? : Models.JobEnableOptions, customHeaders? : { [headerName: string]: string; } }, callback?: msRest.ServiceCallback<void>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
  ...
  terminate(jobId: string, options: { terminateReason? : string, jobTerminateOptions? : Models.JobTerminateOptions, customHeaders? : { [headerName: string]: string; } }, callback: msRest.ServiceCallback<void>): void;
  terminate(jobId: string, options?: { terminateReason? : string, jobTerminateOptions? : Models.JobTerminateOptions, customHeaders? : { [headerName: string]: string; } }, callback?: msRest.ServiceCallback<void>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
  ...
  add(job: Models.JobAddParameter, options: { jobAddOptions? : Models.JobAddOptions, customHeaders? : { [headerName: string]: string; } }, callback: msRest.ServiceCallback<void>): void;
  add(job: Models.JobAddParameter, options?: { jobAddOptions? : Models.JobAddOptions, customHeaders? : { [headerName: string]: string; } }, callback?: msRest.ServiceCallback<void>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
  ...
  list(options: { jobListOptions? : Models.JobListOptions, customHeaders? : { [headerName: string]: string; } }, callback: msRest.ServiceCallback<Models.CloudJobListResult>): void;
  list(options?: { jobListOptions? : Models.JobListOptions, customHeaders? : { [headerName: string]: string; } }, callback?: msRest.ServiceCallback<Models.CloudJobListResult>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
  ...
  listFromJobSchedule(jobScheduleId: string, options: { jobListFromJobScheduleOptions? : Models.JobListFromJobScheduleOptions, customHeaders? : { [headerName: string]: string; } }, callback: msRest.ServiceCallback<Models.CloudJobListResult>): void;
  listFromJobSchedule(jobScheduleId: string, options?: { jobListFromJobScheduleOptions? : Models.JobListFromJobScheduleOptions, customHeaders? : { [headerName: string]: string; } }, callback?: msRest.ServiceCallback<Models.CloudJobListResult>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
  ...
  listPreparationAndReleaseTaskStatus(jobId: string, options: { jobListPreparationAndReleaseTaskStatusOptions? : Models.JobListPreparationAndReleaseTaskStatusOptions, customHeaders? : { [headerName: string]: string; } }, callback: msRest.ServiceCallback<Models.CloudJobListPreparationAndReleaseTaskStatusResult>): void;
  listPreparationAndReleaseTaskStatus(jobId: string, options?: { jobListPreparationAndReleaseTaskStatusOptions? : Models.JobListPreparationAndReleaseTaskStatusOptions, customHeaders? : { [headerName: string]: string; } }, callback?: msRest.ServiceCallback<Models.CloudJobListPreparationAndReleaseTaskStatusResult>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
  ...
  getTaskCounts(jobId: string, options: { jobGetTaskCountsOptions? : Models.JobGetTaskCountsOptions, customHeaders? : { [headerName: string]: string; } }, callback: msRest.ServiceCallback<Models.TaskCounts>): void;
  getTaskCounts(jobId: string, options?: { jobGetTaskCountsOptions? : Models.JobGetTaskCountsOptions, customHeaders? : { [headerName: string]: string; } }, callback?: msRest.ServiceCallback<Models.TaskCounts>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
  ...
  listNext(nextPageLink: string, options: { jobListNextOptions? : Models.JobListNextOptions, customHeaders? : { [headerName: string]: string; } }, callback: msRest.ServiceCallback<Models.CloudJobListResult>): void;
  listNext(nextPageLink: string, options?: { jobListNextOptions? : Models.JobListNextOptions, customHeaders? : { [headerName: string]: string; } }, callback?: msRest.ServiceCallback<Models.CloudJobListResult>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
  ...
  listFromJobScheduleNext(nextPageLink: string, options: { jobListFromJobScheduleNextOptions? : Models.JobListFromJobScheduleNextOptions, customHeaders? : { [headerName: string]: string; } }, callback: msRest.ServiceCallback<Models.CloudJobListResult>): void;
  listFromJobScheduleNext(nextPageLink: string, options?: { jobListFromJobScheduleNextOptions? : Models.JobListFromJobScheduleNextOptions, customHeaders? : { [headerName: string]: string; } }, callback?: msRest.ServiceCallback<Models.CloudJobListResult>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
  ...
  listPreparationAndReleaseTaskStatusNext(nextPageLink: string, options: { jobListPreparationAndReleaseTaskStatusNextOptions? : Models.JobListPreparationAndReleaseTaskStatusNextOptions, customHeaders? : { [headerName: string]: string; } }, callback: msRest.ServiceCallback<Models.CloudJobListPreparationAndReleaseTaskStatusResult>): void;
  listPreparationAndReleaseTaskStatusNext(nextPageLink: string, options?: { jobListPreparationAndReleaseTaskStatusNextOptions? : Models.JobListPreparationAndReleaseTaskStatusNextOptions, customHeaders? : { [headerName: string]: string; } }, callback?: msRest.ServiceCallback<Models.CloudJobListPreparationAndReleaseTaskStatusResult>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
